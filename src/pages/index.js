  ...
  <Layout>
    <article>
      ...
      <Section id="ワークショップについて" className="grayback">
        ...
        <Top3>
          <p>駒場祭期間中に講師によるワークショップを行います。<br></br>グラフィックデザイン概論の中で実際に扱われる題材にゲーム形式で触れられます。<br></br>グラフィックデザイン概論をとろうか迷っている学生の方、あるいは東大でもユニークなこの授業がどんなもんなのか気になる方、どなたでもご自由にお越しください！（予約制ですが、飛び入り参加も歓迎いたします。）</p>
        </Top3>
        <Top4>
          <Schedule 
            schedules={[
